...
instance = subprocess.run(['python3', 'read_instance.py', 'puzznic1'], text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
# ------------------------------------------------ Axioms -------------------------------------------------------------
# are any blocks requiring to fall
